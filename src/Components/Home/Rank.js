    ...
    <>
      ...
      <section className={`${Style.ranking} sec`}>
        ...
        <div className={Style.ranking_inner}>
          <Swiper navigation={true} modules={[Navigation]} className="mySwiper" id='rank_swiper'>
            <SwiperSlide>
              <p className={Style.rank_img}><img src="/images/rank0.png" alt="1위" /></p>
              <p className={Style.rank_num}><span>1</span>위</p>
            ...
            <SwiperSlide>
              <p className={Style.rank_img}><img src="/images/rank1.png" alt="2위" /></p>
              <p className={Style.rank_num}><span>2</span>위</p>
              <p className={Style.rank_name}>로제 청하 스파클링</p>
            ...
            <SwiperSlide>
              <p className={Style.rank_img}><img src="/images/rank2.png" alt="3위" /></p>
              <p className={Style.rank_num}><span>3</span>위</p>
              <p className={Style.rank_name}>순하리 레몬진 스트롱</p>
            ...
            <SwiperSlide>
              <p className={Style.rank_img}><img src="/images/rank3.png" alt="4위" /></p>
              <p className={Style.rank_num}><span>4</span>위</p>
              <p className={Style.rank_name}>CU 츄-하이 리치</p>
            ...
            <SwiperSlide>
              <p className={Style.rank_img}><img src="/images/rank4.png" alt="5위" /></p>
              <p className={Style.rank_num}><span>5</span>위</p>
              <p className={Style.rank_name}>서울의 밤 40%</p>
